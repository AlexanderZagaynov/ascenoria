...
macro_rules! impl_localized_entity {
    ($type:ty) => {
        impl $crate::data::localization::LocalizedEntity for $type {
            fn name_text(&self) -> &$crate::data::localization::LocalizedText {
                &self.name
            }

            fn description_text(&self) -> &$crate::data::localization::LocalizedText {
                &self.description
            }
        }
    };
...
macro_rules! impl_has_id {
    ($type:ty) => {
        impl $crate::data::localization::HasId for $type {
            fn id(&self) -> &str {
                &self.id
            }
        }
