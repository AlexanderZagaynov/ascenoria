use crate::data_types::entities::{Engine, PlanetaryItem, Tech, Weapon};
...
fn computes_derived_stats_for_sample_dataset() {
    ...
    crate::data_types::validation::validate_game_data(&data)
...
fn computes_derived_stats() {
    ...
    data.weapons_mut().push(Weapon {
        ...
        uses_per_turn: 3,
        industry_cost: 1,
        tech_index: crate::data_types::NO_TECH_REQUIREMENT,
    });
    data.engines_mut().push(Engine {
