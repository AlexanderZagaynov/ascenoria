...
use crate::data_types::entities::VictoryRules;
...
pub(crate) fn load_mod_datasets(mods_dir: &Path) -> Result<ModDatasets, DataLoadError> {
    ...
    for entry in entries {
        ...
        let schema_version = manifest
            ...
            .unwrap_or(crate::data_types::loaders::DATA_SCHEMA_VERSION);
        if schema_version > crate::data_types::loaders::DATA_SCHEMA_VERSION {
            return Err(DataLoadError::UnsupportedSchemaVersion {
                found: schema_version,
                current: crate::data_types::loaders::DATA_SCHEMA_VERSION,
